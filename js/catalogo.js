...
// Catálogo Enriquecido con Imágenes Profesionales Curadas y Ficha Técnica
const LUSSO_SERVICES_CATALOG = [
  // --- 💅 MANICURE ---
  {
    ...
    description: 'El servicio favorito de nuestras clientas. Esmaltado en gel de brillo ultra duradero curado bajo lámpara UV. No se descascara ni pierde brillo durante semanas.',
    includes: 'Incluye limado, retiro del gel anterior y ritual con aceite nutritivo de cutícula.',
    recommendedFor: 'Ideal para quienes buscan uñas impecables por 2 a 3 semanas sin preocuparse por retoques diarios.',
  ...
  },
  {
    ...
    description: 'Base de gel densa y flexible que aporta estructura y fortaleza a las uñas naturales débiles o escamadas sin necesidad de extensión artificial.',
    includes: 'Manicure completa, nivelación con Rubber Gel, esmaltado al gusto y aceite de cutícula.',
    recommendedFor: 'Perfecto para clientas con uñas quebradizas o finas que desean dejarlas crecer naturalmente con fuerza.',
  ...
  },
  {
    ...
    description: 'Extensión completa de uñas con polímero acrílico de alta gama. Esculpido preciso en forma cuadrada, almendrada, coffin o stiletto con acabado perfecto.',
    includes: 'Preparación profunda, extensión en tips o molde, limado arquitectónico y aceite de cutícula.',
  ...
  },
  {
    ...
    description: 'Lo mejor del acrílico y del gel en un solo producto. Extensión inodora, súper ligera y flexible que se siente completamente como uña natural.',
    includes: 'Manicure previa, modelado con polygel hipoalergénico, acabado glossy y aceite de argán en cutículas.',
    recommendedFor: 'Clientas sensibles a los olores del monómero tradicional que buscan comodidad y durabilidad.',
  ...
  },
  {
    ...
    description: 'Sistema híbrido de esmaltado tradicional con tecnología ProStay de OPI. Proporciona hasta 11 días de brillo efecto gel con secado al aire.',
    ...
    aftercare: 'Usar guantes para lavado de vajilla doméstica.'
  },
  {
    id: 'srv-1',
    ...
    description: 'Protocolo de higiene y mantenimiento rápido para manos prolijas, limpias e hidratadas. Uñas pulidas sin aplicación de color.',
    includes: 'Desinfección, limado de forma y largo, retiro de cutículas, pulido natural y crema emoliente.',
  ...
  // --- 🦶 PEDICURE ---
  {
    ...
    description: 'Experiencia relajante y restauradora para los pies con la gama de lujo OPI ProSpa. Suaviza talones agrietados y renueva la piel por completo.',
    includes: 'Baño de sales aromáticas, gel removedor de callosidades OPI, exfoliación con cristales de azúcar, masaje relajante y esmaltado a elección.',
    recommendedFor: 'Ideal para pies cansados o talones resecos que necesitan recuperación total y suavidad aterciopelada.',
  ...
  },
  {
    ...
    description: 'Esmaltado en gel curado en lámpara en las uñas de los pies. Sal del salón lista con calzado cerrado sin riesgo de mancharte.',
    includes: 'Limpieza de cutículas, limado, esmaltado en gel de alta resistencia e hidratación profunda.',
    recommendedFor: 'Imprescindible para viajes, vacaciones o si usas calzado deportivo/cerrado inmediatamente después de la cita.',
  ...
  },
  {
    ...
    description: 'Protocolo de belleza y frescura para los pies con sales minerales, exfoliación suave y esmaltado clásico OPI.',
    ...
    aftercare: 'Asistir con sandalias abiertas para el secado.'
  },
  ...
  // --- ✂️ CORTE & STYLING ---
  {
    ...
    description: 'Transformación o diseño de corte completo (bob, mariposa, capas largas, flequillos, desfilados). Diseñado por Kiara según el movimiento de tu cabello.',
  ...
  },
  {
    ...
    description: 'Despunte técnico milimétrico que elimina horquillas y puntas abiertas sin sacrificar el largo que tanto te costó hacer crecer.',
  ...
  },
  {
    ...
    description: 'Brushing con secador y cepillo redondo para dejar el cabello pulido, con movimiento natural, cero frizz y brillo radiante.',
    includes: 'Lavado con champú orgánico, protector térmico, cepillado y acabado de argán.',
  ...
  },
  {
    ...
    description: 'Alisado térmico temporal con plancha de placas de titanio que sella la cutícula, dejando un efecto ultra lacio y reflectivo.',
  ...
  },
  {
    ...
    description: 'Lavado higiénico en bacha con masaje capilar y secado manual para salir con el cabello limpio, seco y acondicionado.',
    includes: 'Champú purificante, acondicionador desenredante y secado manual con aire tibio.',
  ...
  // --- 🎨 COLORIMETRÍA ---
  {
    ...
    description: 'La técnica estrella para morenas y castañas. Aporta luz y dimensión con matices miel, avellana, chocolate cálido o caramelo sin el mantenimiento demandante de un rubio total.',
  ...
  },
  {
    ...
    description: 'Técnica de alta precisión y arte capilar para lograr rubios dorados, vainilla, perla o beige sin líneas marcadas y con transición perfecta.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?auto=format&fit=crop&w=800&q=80',
    description: 'Aplicación localizada en la zona de crecimiento para cubrir el 100% de canas o igualar el color base del cabello sin sobreprocesar las puntas.',
  ...
  // --- ✨ TRATAMIENTOS & ALISADOS ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?auto=format&fit=crop&w=800&q=80',
    description: 'Tratamiento intensivo con colágeno, aminoácidos y ácido hialurónico. Rellena las fisuras de la hebra capilar porosa, elimina el frizz y devuelve la sedosidad perdida.',
  ...
  // --- 🧴 RETIROS & CUIDADOS ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1515688594390-b649af70d282?auto=format&fit=crop&w=800&q=80',
    description: 'Retiro seguro del esmalte en gel sin limar la placa ungueal ni raspar agresivamente la queratina natural de la uña.',
  ...
  },
  {
    ...
    badge: '🌿 Sin Daño',
    image: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&w=800&q=80',
    description: 'Disolución y retiro cuidadoso del refuerzo rubber preservando el grosor y fuerza natural de la uña.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?auto=format&fit=crop&w=800&q=80',
    description: 'Desprendimiento suave de extensiones acrílicas con solvente especializado y baño nutritivo de cutícula.',
    includes: 'Desbaste con fresa suave, remojo hidratante, limado suave y endurecedor.',
    recommendedFor: 'Descanso de extensiones sin arrancar ni debilitar la uña.',
  ...
  },
  {
    ...
    badge: '🎨 Color Express',
    image: 'https://images.unsplash.com/photo-1599940824399-b87987ceb72a?auto=format&fit=crop&w=800&q=80',
    description: 'Retiro del esmalte anterior tradicional y aplicación de una nueva capa de color OPI de secado normal.',
  ...
  },
  {
    ...
    badge: '🌿 Express',
    image: 'https://images.unsplash.com/photo-1506152983158-b4a74a01c721?auto=format&fit=crop&w=800&q=80',
    description: 'Retiro simple de esmalte común con removedor libre de acetona abrasiva e hidratación.',
      ...
      html += `
        <article class="service-visual-card ${s.bestSeller ? 'bestseller-highlight' : ''}" data-id="${s.id}">
          <div class="card-media-wrapper">
            <img src="${s.image}" alt="${s.name}" class="card-img" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=800&q=80'">
  ...
  openModal(id) {
    ...
    modalContent.innerHTML = `
      ...
      <div class="modal-media-header">
        <img src="${s.image}" alt="${s.name}" class="modal-header-img" onerror="this.src='https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=800&q=80'">
      </div>
